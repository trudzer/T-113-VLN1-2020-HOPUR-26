...
class LogicMain:
    ...
    def change_vehicle(self,vehicleInfoList):
        OGVehicleVar = self.data.GetData([vehicleInfoList[0],"vehicle"]) # nær í gamla faratækið með ID
        NoC="None"
        vehicleInfoList2=[]
        for i in vehicleInfoList[1:]: #fer yfir listan svo hann sé á réttu formati
            if i == NoC:
                i=None
