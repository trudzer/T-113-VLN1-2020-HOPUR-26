...
class LLVehicle:
    ...
    def TestVehicleList(self, VehicleVarList):
        ...
        VehicleVar= [str(VehicleVarList[0]),nameVar,licence_plateVar, isRentedVar,categoriesVar,locationVar,conditionVar, colorVar, yearModelVar, taxVar,km_drivenVar, typeVar]
        VehicleVarStr=[]
        for i in VehicleVar:
    ...
    def changeVehicle(self, VehicleVarList, OGVehicleVar):
        ...
        #búatil nýtt fara tæki til að setja í staðinn
        NewVehicle = [str(VehicleVarList[0]),nameVar,licence_plateVar, isRentedVar,categoriesVar,locationVar,conditionVar, colorVar, yearModelVar, taxVar, km_drivenVar, vehicle_typeVar]
...
class LLEmployee:
    ...
    def TestEmployeeList(self, EmployeeVarList):
        ...
        return [str(EmployeeVarList[0]), nameVar, ktVar, addressVar, EmailVar, GSMVar, HomePhoneVar,LocartionVar] #Employee(nameVar, ktVar, addressVar, EmailVar, GSMVar, HomePhoneVar,LocartionVar)
    ...
    def changeEmployee(self, EmployeeVarList, OGEmployeeVar):
        ...
        #búatil nýtt fara tæki til að setja í staðinn
        NewEmployee = [str(EmployeeVarList[0]),nameVar, ktVar, addressVar, EmailVar, GSMVar, HomePhoneVar, LocationVar]
        return NewEmployee
